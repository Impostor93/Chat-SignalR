...
namespace Chat.DAL
{
    ...
    public partial class ChatEntities : DbContext
    {
        ...
        public virtual DbSet<tblChatUserStatus> tblChatUserStatus1 { get; set; }
        public virtual DbSet<tblRoomMessageSession> tblRoomMessageSessions { get; set; }
        public virtual DbSet<tblRoomUser> tblRoomUsers { get; set; }
